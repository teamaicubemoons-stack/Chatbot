...
export default function App() {
  ...
  const handleSend = async (textToSend) => {
    ...
    try {
      ...
      const errorMessage = "Honestly, I had a slight connection hiccup trying to reach my backend brain. Make sure the FastAPI service is running on http://localhost:8000! Let's get that up and try again."
